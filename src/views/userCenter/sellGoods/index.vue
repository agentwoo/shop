...
import sellGoodsList from '@/views/userCenter/sellGoods/components/sellGoodsList.vue'
...
<template>
    <div class="container">
        ...
        <div class="container_tip" v-if="goodsItemStore.goodsItem.length === 0">
            <el-empty :image-size="250" description="暂无卖出记录" />
        </div>
        <div class="container_show" v-else>
            <sellGoodsList :sellGoodsList="goodsItemStore.goodsItem"></sellGoodsList>
        </div>
    </div>
</template>
